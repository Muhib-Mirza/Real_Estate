      ...
      transition={{
       ...
       >
        ...
        <motion.a
          ...
          onMouseEnter={() => {
            document.querySelector(".cimg2").style.filter = "brightness(1)";
          }}
          onMouseLeave={() => {
            document.querySelector(".cimg2").style.filter = "brightness(0.8)";
          }}
        >
          <div className={cstyle.card}>
            <img
        ...
        <motion.a
          ...
          onMouseEnter={() => {
            document.querySelector(".cimg3").style.filter = "brightness(1)";
          }}
          onMouseLeave={() => {
            document.querySelector(".cimg3").style.filter = "brightness(0.8)";
          }}
        >
          <div className={cstyle.card}>
            <img
